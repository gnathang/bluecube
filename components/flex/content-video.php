...
$vimeo_or_native = get_sub_field('vimeo_or_native');
$native_video = get_sub_field('native_video');

?>


<section class="full_width video_wrapper fade-in" id="row-<?php echo $row; ?>">

    <?php if($vimeo_or_native == false) { ?>
    ...
    <video autoplay muted loop class="native_video">
        <source src="<?php echo $native_video; ?>" type="video/mp4">
    </video>
